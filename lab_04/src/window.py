...
class Window():
    ...
    def createInterface(self):
        ...
        Label(text = "Вероятность возврата заявки", font = ("Arial", 16), bg = "#e0e0eb",
            fg = "#29293d").place(width = self.windowWidth * 0.6, height = 20, x = 1, y = 360)
        ...
        self.countTasksEntry.place(width = self.windowWidth * 0.3, height = 30, x = self.windowWidth * 0.6, y = 330)

        self.repeatProbabilityEntry = Entry(font = ("Arial", 17))
        self.repeatProbabilityEntry.place(width = self.windowWidth * 0.3, height = 30, x = self.windowWidth * 0.6, y = 360)

        self.stepEntry = Entry(font = ("Arial", 17))
        self.stepEntry.place(width = self.windowWidth * 0.3, height = 30, x = self.windowWidth * 0.6, y = 390)
